...
function useStylish(prefixCls, _ref) {
  ...
  return (0, _proProvider.useStyle)('ProLayoutSiderMenuStylish', function (token) {
    ...
    if (!stylish) return [];
    return [(0, _defineProperty2.default)({}, token.proComponentsCls, (0, _defineProperty2.default)({}, "".concat(token.proComponentsCls, "-layout"), (0, _defineProperty2.default)({}, "".concat(siderMenuToken.componentCls), stylish === null || stylish === void 0 ? void 0 : stylish(siderMenuToken))))];
  });
}
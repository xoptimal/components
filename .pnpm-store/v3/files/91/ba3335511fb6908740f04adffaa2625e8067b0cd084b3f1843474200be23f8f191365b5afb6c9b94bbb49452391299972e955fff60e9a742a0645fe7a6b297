...
var compatibleStyle = function compatibleStyle(token) {
  ...
  if ((_getVersion = getVersion()) === null || _getVersion === void 0 ? void 0 : _getVersion.startsWith('5')) {
    return {};
  }
  return _ref = {}, (0, _defineProperty2.default)(_ref, token.proComponentsCls, {
    width: '100%',
    height: '100%'
  }), (0, _defineProperty2.default)(_ref, token.componentCls, (_token$componentCls = {
    width: '100%',
    height: '100%'
...
var genProLayoutStyle = function genProLayoutStyle(token) {
  ...
  return (0, _defineProperty2.default)({
  ...
  }, token.proComponentsCls, (_token$proComponentsC = {}, (0, _defineProperty2.default)(_token$proComponentsC, "".concat(token.antCls, "-layout"), {
    backgroundColor: 'transparent !important'
  }), (0, _defineProperty2.default)(_token$proComponentsC, "& ".concat(token.componentCls), (_$concat12 = {}, (0, _defineProperty2.default)(_$concat12, "& ".concat(token.antCls, "-layout"), {
    display: 'flex',
    backgroundColor: 'transparent',
    width: '100%'
  }), (0, _defineProperty2.default)(_$concat12, "".concat(token.componentCls, "-content"), {
    display: 'flex',
  ...
  }), (0, _defineProperty2.default)(_$concat12, "".concat(token.componentCls, "-container"), {
    width: '100%',
    display: 'flex',
    flexDirection: 'column',
    minWidth: 0,
    minHeight: 0,
    backgroundColor: 'transparent'
  }), (0, _defineProperty2.default)(_$concat12, "".concat(token.componentCls, "-bg-list"), {
    pointerEvents: 'none',
    position: 'fixed',
    overflow: 'hidden',
    insetBlockStart: 0,
  ...
  }), _$concat12)), (0, _defineProperty2.default)(_token$proComponentsC, "".concat(token.antCls, "-menu-submenu-popup"), {
    backgroundColor: 'rgba(255, 255, 255, 0.42)',
    '-webkit-backdrop-filter': 'blur(8px)',
    backdropFilter: 'blur(8px)'

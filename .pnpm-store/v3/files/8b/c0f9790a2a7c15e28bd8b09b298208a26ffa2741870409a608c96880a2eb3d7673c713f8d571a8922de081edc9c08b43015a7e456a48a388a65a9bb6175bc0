...
export type ProSchemaRenderValueTypeFunction<T = any, ValueType = any> = (item: ProFormRenderValueTypeItem<T, ValueType>, helpers: ProFormRenderValueTypeHelpers<T, ValueType>) => React.ReactNode;

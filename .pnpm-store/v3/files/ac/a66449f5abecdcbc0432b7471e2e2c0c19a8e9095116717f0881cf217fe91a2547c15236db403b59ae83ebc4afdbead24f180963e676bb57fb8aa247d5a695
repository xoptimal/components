  ...
  if (items) {
    return items.map(function (item) {
      return (0, _objectSpread2.default)((0, _objectSpread2.default)({}, item), {}, {
        children: (0, _jsxRuntime.jsx)(_Card.default, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, tabs === null || tabs === void 0 ? void 0 : tabs.cardProps), {}, {
...
var TabPane = function TabPane(props) {
  ...
  if (_antd.version.startsWith('5')) {
    ...
    return (0, _jsxRuntime.jsx)(_antd.Tabs.TabPane, (0, _objectSpread2.default)((0, _objectSpread2.default)({
      tabKey: tabKey,
      tab: tab,

...
declare type SourceMap = string | null | undefined;
 ...
 */
export declare type IBundlessLoader = (this: Omit<ExtendedLoaderContext, 'async'> & ILoaderContext & {
    cwd: string;
...
declare type IJSTransformerResult = [ILoaderOutput['content'], SourceMap?];
/**
 * bundless transformer type
 */
export declare type IJSTransformer = (this: ILoaderContext & {
    paths: {
        cwd: string;
        fileAbsPath: string;
        itemDistAbsPath: string;

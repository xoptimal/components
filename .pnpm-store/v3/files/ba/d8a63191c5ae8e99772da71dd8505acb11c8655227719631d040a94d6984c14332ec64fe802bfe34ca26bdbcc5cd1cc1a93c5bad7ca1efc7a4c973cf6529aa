...
function useStylish(prefixCls, _ref) {
  ...
  return (0, _proProvider.useStyle)('ProLayoutPageContainerStylish', function (token) {
    ...
    if (!stylish) return [];
    return [(0, _defineProperty2.default)({}, token.proComponentsCls, (0, _defineProperty2.default)({}, "".concat(stylishToken.componentCls), stylish === null || stylish === void 0 ? void 0 : stylish(stylishToken)))];
  });
}
...
var BaseProFormUploadButton = function BaseProFormUploadButton(_ref, ref) {
  ...
  return (0, _jsxRuntime.jsx)(_antd.Upload, (0, _objectSpread2.default)((0, _objectSpread2.default)({
    action: action,
    accept: accept,
    ref: ref,
    ...
    children: showUploadButton && (isPictureCard ? (0, _jsxRuntime.jsxs)("span", {
      children: [icon, " ", title]
    }) : (0, _jsxRuntime.jsxs)(_antd.Button, (0, _objectSpread2.default)((0, _objectSpread2.default)({

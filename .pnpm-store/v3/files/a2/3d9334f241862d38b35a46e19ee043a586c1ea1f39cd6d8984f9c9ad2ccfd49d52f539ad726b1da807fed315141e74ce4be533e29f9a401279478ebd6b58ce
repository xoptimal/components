...
var QueryFilterContent = function QueryFilterContent(props) {
  ...
  var processedList = flatMapItems(items, props.ignoreRules).map(function (item, index) {
    ...
    var hidden = (item === null || item === void 0 ? void 0 : (_item$props5 = item.props) === null || _item$props5 === void 0 ? void 0 : _item$props5.hidden) ||
    // 如果收起了
  ...
  return (0, _jsxRuntime.jsxs)(_antd.Row, {
    ...
    justify: "start",
    children: [doms, submitter && (0, _jsxRuntime.jsx)(_antd.Col, {
      span: spanSize.span,
      offset: offset,
      style: {
        textAlign: 'end'

...
var gridHelpers = function gridHelpers(_ref) {
  ...
  return {
    ...
    RowWrapper: function RowWrapper() {
      ...
      return (0, _jsxRuntime.jsx)(_antd.Row, (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({
        gutter: 8
      }, rowProps), props), {}, {
        children: children
      }));
    ...
    ColWrapper: function ColWrapper() {
      ...
      return (0, _jsxRuntime.jsx)(_antd.Col, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, props), {}, {
        children: children
      }));
    }
  };

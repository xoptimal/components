...
var StatisticSkeleton = function StatisticSkeleton(_ref2) {
  ...
  return (0, _jsxRuntime.jsx)(_antd.Card, {
    bordered: false,
    style: {
      marginBlockEnd: 16
    },
    children: (0, _jsxRuntime.jsx)("div", {
      ...
      children: new Array(arraySize).fill(null).map(function (_, index) {
        return (0, _jsxRuntime.jsxs)("div", {
          ...
          }), (0, _jsxRuntime.jsx)(_antd.Skeleton.Button, {
            active: active,
            style: {
              height: 48
            }
...
var ListSkeletonItem = function ListSkeletonItem(_ref3) {
  ...
  return (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
    children: [(0, _jsxRuntime.jsx)(_antd.Card, {
      bordered: false,
...
var ListSkeleton = function ListSkeleton(_ref4) {
  ...
  return (0, _jsxRuntime.jsxs)(_antd.Card, {
    bordered: false,
    bodyStyle: {
      padding: 0
    },
    children: [new Array(size).fill(null).map(function (_, index) {
    ...
    }), actionButton !== false && (0, _jsxRuntime.jsx)(_antd.Card, {
      bordered: false,
      style: {
      ...
      children: (0, _jsxRuntime.jsx)(_antd.Skeleton.Button, {
        style: {
          width: 102
        },
        active: active,
...
var ListPageSkeleton = function ListPageSkeleton(_ref7) {
  ...
  return (0, _jsxRuntime.jsxs)("div", {
    ...
    children: [pageHeader !== false && (0, _jsxRuntime.jsx)(PageHeaderSkeleton, {
      ...
      size: statistic,
      active: active
    }), (toolbar !== false || list !== false) && (0, _jsxRuntime.jsxs)(_antd.Card, {
      bordered: false,
      bodyStyle: {
        padding: 0
      },

...
export function useStylish(prefixCls, _ref) {
  ...
  return useAntdStyle('ProLayoutSiderMenuStylish', function (token) {
    ...
    if (!stylish) return [];
    return [_defineProperty({}, token.proComponentsCls, _defineProperty({}, "".concat(token.proComponentsCls, "-layout"), _defineProperty({}, "".concat(siderMenuToken.componentCls), stylish === null || stylish === void 0 ? void 0 : stylish(siderMenuToken))))];
  });
}
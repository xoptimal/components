...
var InlineErrorFormItemPopover = function InlineErrorFormItemPopover(_ref) {
  ...
  return (0, _jsxRuntime.jsx)(_antd.Popover, (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({
    ...
    content: wrapSSR((0, _jsxRuntime.jsxs)("div", {
  ...
  return (0, _jsxRuntime.jsx)(_antd.Form.Item, (0, _objectSpread2.default)((0, _objectSpread2.default)({
    ...
    _internalItemRender: {
      ...
      render: function render(inputProps, doms) {
        return (0, _jsxRuntime.jsx)(InlineErrorFormItemPopover, (0, _objectSpread2.default)({
...
var InlineErrorFormItem = function InlineErrorFormItem(props) {
  ...
  if (name && (rules === null || rules === void 0 ? void 0 : rules.length) && errorType === 'popover') {
    return (0, _jsxRuntime.jsx)(InternalFormItemFunction, (0, _objectSpread2.default)((0, _objectSpread2.default)({
      name: name,
      rules: rules,
      popoverProps: popoverProps
    }, rest), {}, {
